 ...
 * @Description: com.sh3h.base.util
 * @Version:1.0
 */
public class PrivacyUtil {
    ...
    public static String hidePhone_not_include_last(String phone) {
        return phone.replaceAll("(\\d{3})\\d{4}(\\d{4})", "$1****");
    }

    public static String hidePhone_include_last(String phone) {
        return phone.replaceAll("(\\d{3})\\d{4}(\\d{4})", "$2");
    }

    public static String hidePhone_include_first(String phone) {
        return phone.replaceAll("(\\d{3})\\d{4}(\\d{4})", "$1");
    }
